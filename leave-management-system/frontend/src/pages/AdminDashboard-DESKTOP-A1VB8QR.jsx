                        ...
                        <td>
                          {leave.status === 'pending' ? (
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem', alignItems: 'flex-start' }}>
                              <span style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)', fontStyle: 'italic', marginBottom: '0.25rem' }}>
                                Reviewed by {leave.reviewedBy?.name || 'Admin'}
                              </span>
                              <button 
                                onClick={() => openReviewModal(leave, leave.status)} 
                                className="btn btn-outline" 
                                style={{ padding: '0.25rem 0.5rem', fontSize: '0.75rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-color)' }}
                                title="Change Status"
                              >
                                Change Status
                              </button>
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h3 style={{ fontSize: '1.125rem', fontWeight: 700 }}>
                Review Request for {selectedLeave.employee?.name}
              </h3>
            ...
            <form onSubmit={handleReviewSubmit}>
              <div className="modal-body">
                ...
                <div style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', marginBottom: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <div className="modal-footer">
                ...
                <button 
                  ...
                  className={reviewAction === 'approved' ? 'btn btn-success' : (reviewAction === 'rejected' ? 'btn btn-danger' : 'btn-primary')}
                  style={{ minWidth: '120px' }}
                >
                  {submitLoading ? 'Saving...' : 'Save Decision'}
                </button>
              </div>
            </form>
          </div>
